...
const validator: ValidatorType = {
  ...
  price: validatePrice,
  description: (value) => validateValue(value, DescriptionLength.Min, DescriptionLength.Max),
  trainingDescription: (value) => validateValue(value, DescriptionLength.Min, DescriptionLength.Max),
  userDescription: (value) => validateValue(value, DescriptionLength.Min, DescriptionLength.Max, false),
